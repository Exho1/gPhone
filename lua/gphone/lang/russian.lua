...
local l = gPhone.createLanguage( "Russian" )
...
-- Data transfer
l.transfer_fail_gm = "Нельзя передавать  деньги, для этого нужен мод DarkRP."
...
l.app_store = "Магазин приложений"
...
-- Flappy Garry
l.enter_play = "Пожалуйста 'enter' чтобы играть!"